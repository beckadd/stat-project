...
output %>%
  ...
  kable(col.names = c("Interquartile Range", "Median", "Mean"))
```
...
The median GDP for North African countries is `r rmg[1]` billion dollars; the median GDP for sub-Saharan countries is `r rmg[2]` billion dollars. Therefore, the difference in median GDP between North African and sub-Saharan countries is `r abs(rmg[1] - rmg[2])` billion dollars.
