...
Since our p-value of 0.614 is greater than our significance level of 0.05, we fail to reject the null hypothesis. The data does not provide convincing evidence that there is a significant difference between the median GDP of North African countries comapred to sub-Saharan countries.
...
Now, we are going to calculate the r-value. We are going to be using a R adjusted value because there are multiple variables in the model.
